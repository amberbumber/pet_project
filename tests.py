...
class UserModelCase(unittest.TestCase):
    ...
    def test_avatar(self):
        u = User(username='john', email='john@superjohn.com')
        self.assertEqual(u.avatar(128),
                         ('https://www.gravatar.com/avatar/bc837600cbeb13de6bb2751572dd8d1a?d=identicon&s=128'))
    ...
    def test_follow_posts(self):
        ...
        # проверяем посты для подписанных пользователей
